...
namespace VL1.Tests.Pages.Extensions
{
    ...
    public class ConstantsTests: BaseTests
    {
        ...
        [TestMethod] public void ProdceduresPageTitleTest() =>  Assert.AreEqual("Prodcedures", Constants.ProdceduresPageTitle);
        [TestMethod] public void ProductTypesPageTitleTest() => Assert.AreEqual( "Product Types", Constants.ProductTypesPageTitle);
        [TestMethod] public void RulesPagePageTitleTest() => Assert.AreEqual( "Rules", Constants.RulesPagePageTitle);
        [TestMethod] public void RuleSetsPagePageTitleTest() => Assert.AreEqual( "Rule Sets", Constants.RuleSetsPagePageTitle);
